...
public class ActionEventExample extends JFrame implements ActionListener{
    ...
    public ActionEventExample(){
        ...
        // setting sefault close operaton
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == btn_result){
            ...
            System.out.println(txt_num_one.getText());
            System.out.println(txt_num_two.getText());
            try{
                int a = Integer.parseInt(txt_num_one.getText());
                int b = Integer.parseInt(txt_num_two.getText());
